...
<path d="M11.6666 9.16667V14.1667" stroke="#B6B6B6" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round"/>
        ...
        {items.map(el => 
          <CartItem key={el.id} id={el.id} title={el.title} image={el.image} price={el.price} count={el.count} type={el.type} size={el.size}/>
        )}
        
            </div>
            <div class="cart__bottom">
              <div class="cart__bottom-details">
                <span> Всего пицц: <b>{items.reduce((sum, el) => el.count + sum, 0)} шт.</b> </span>
